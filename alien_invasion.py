...
def run_game():
    ...
    # 开始游戏主循环
    while True:
        gf.check_events(ai_settings, screen, stats, sb, play_button, ship, ghosts, bullets)
        ...
        gf.update_screen(ai_settings, screen, stats, sb, ship, ghosts, bullets, play_button)
